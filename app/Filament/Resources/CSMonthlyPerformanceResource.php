...
use App\Filament\Resources\CSMonthlyPerformanceResource\Pages;
...
class CSMonthlyPerformanceResource extends Resource
{
    protected static ?string $model = LaporanPerolehan::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';
    protected static ?string $navigationLabel = 'PEROLEHAN BULANAN 2024';
        ...
        return $table
            ...
            ->query(
                ...
                ->selectRaw('
                    MIN(id) AS id, 
                    nama_cs,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 1, jml_perolehan, 0)) AS Januari,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 2, jml_perolehan, 0)) AS Februari,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 3, jml_perolehan, 0)) AS Maret,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 4, jml_perolehan, 0)) AS April,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 5, jml_perolehan, 0)) AS Mei,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 6, jml_perolehan, 0)) AS Juni,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 7, jml_perolehan, 0)) AS Juli,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 8, jml_perolehan, 0)) AS Agustus,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 9, jml_perolehan, 0)) AS September,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 10, jml_perolehan, 0)) AS Oktober,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 11, jml_perolehan, 0)) AS November,
                    SUM(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 12, jml_perolehan, 0)) AS Desember,
                    SUM(IF(YEAR(tanggal) = 2024, jml_perolehan, 0)) AS total_perolehan,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 1 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_Januari,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 1) AS Transaksi_Januari,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 2 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_Februari,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 2) AS Transaksi_Februari,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 3 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_Maret,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 3) AS Transaksi_Maret,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 4 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_April,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 4) AS Transaksi_April,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 5 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_Mei,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 5) AS Transaksi_Mei,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 6 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_Juni,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 6) AS Transaksi_Juni,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 7 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_Juli,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 7) AS Transaksi_Juli,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 8 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_Agustus,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 8) AS Transaksi_Agustus,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 9 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_September,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 9) AS Transaksi_September,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 10 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_Oktober,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 10) AS Transaksi_Oktober,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 11 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_November,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 11) AS Transaksi_November,
                    COUNT(IF(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 12 AND jml_perolehan > 0, jml_perolehan, NULL)) AS Donatur_Berdonasi_Desember,
                    SUM(YEAR(tanggal) = 2024 AND MONTH(tanggal) = 12) AS Transaksi_Desember
                ')
            ...
            ->filters([
                // Tambahkan filter dinamis jika diperlukan
            ])
    ...
    {
        return [
            'index' => Pages\ListCSMonthlyPerformances::route('/'),
            'create' => Pages\CreateCSMonthlyPerformance::route('/create'),
            'edit' => Pages\EditCSMonthlyPerformance::route('/{record}/edit'),
        ];
    }
}
